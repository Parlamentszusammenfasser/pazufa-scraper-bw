...
- Entwurf / Beschlussempfehlung additionally carry the partial summaries `intention-llm`, `regelungsinhalt-llm`, `kosten-llm` from the same call, mirrored from the BB scraper (DD-056)
